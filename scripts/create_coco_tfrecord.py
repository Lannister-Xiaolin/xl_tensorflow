...
from xl_tensorflow.datasets.tfrecord import label_map_util
...
def _load_object_annotations(object_annotations_file):
    ...
    return img_to_obj_annotation, category_index, [image for image in images if image['id'] in img_to_obj_annotation]
...
def _create_tf_record_from_coco_annotations(images_info_file,
    ...
    if object_annotations_file:
        img_to_obj_annotation, category_index, images = (

...
from . import argmax_matcher
from . import balanced_positive_negative_sampler
from . import box_list
from . import faster_rcnn_box_coder
from . import region_similarity_calculator
from . import target_assigner
        ...
        for level in range(self.min_level, self.max_level + 1):
            ...
            for scale in range(self.num_scales):
                for aspect_ratio in self.aspect_ratios:
                    ...
                    # retinanet 默认anchor_size为4，最小level为3，最大为7

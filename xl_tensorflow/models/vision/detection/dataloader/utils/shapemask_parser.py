...
from . import anchor_rcnn as anchor
from . import mode_keys as ModeKeys
...
class Parser(object):
  ...
  def _parse_predict_data(self, data):
    ...
    if self._mode == ModeKeys.PREDICT_WITH_GT:
      ...
      groundtruths['source_id'] = input_utils.process_source_id(
          groundtruths['source_id'])
      groundtruths = input_utils.pad_groundtruths_to_fixed_size(
